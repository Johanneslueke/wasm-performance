...
@Component({
  selector: "app-fibRust",
  templateUrl: "./fibonacci.component.html",
})
export class WasmFibonacci_RUST_Component /*extends EmscriptenWasmComponent*/ implements OnInit, OnDestroy {
  loaded: boolean;
  number: number;
  runs: number;
  ...
  constructor(private http: HttpClient) {
    //super("fibonacci_rust_bg","fibonacci_rust.js")
    this.number = 25;
    this.runs = 10;
  }
  ...
  ngOnInit() {
    ...
    // to work with it
    this.instantiateWasm(`${environment.wasmAssetsPath}/fibonacci_rust_bg.wasm`, {}).then((result) => {
